...
<head>
  ...
  <title>TodoInmuebles</title>
  <link rel="icon" type="image/jpg" href="<?php echo get_template_directory_uri(); ?>/assets/img/favi.png" style="width: 30px; height: 30px;">
  ...
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/media.css" type="text/css" media="all">
...
<body>
  ...
  <!-- <div class="btn-facebook">
    <a href="https://m.me/todoinmuebles" target="_blank">
